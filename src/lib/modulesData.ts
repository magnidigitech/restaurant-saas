...
export const RESTO_BIRD_MODULES: Record<string, ModuleData> = {
  pos: {
    slug: "pos",
    name: "POS Integrations & Orders Hub",
    shortName: "POS Integrations",
    category: "front-of-house",
    categoryLabel: "Front of House Integrations",
    tagline: "Connect your existing POS. Bring your restaurant orders into one clear dashboard.",
    heroBadge: "TOAST • SQUARE • CLOVER INTEGRATIONS",
    seoTitle: "Restaurant POS Integrations & Unified Orders Hub",
    description:
      "Restobird connects directly to your restaurant's existing POS systems—including Toast, Square, and Clover. Import live orders, line-item modifiers, and sales data into one consolidated, real-time reporting dashboard without replacing your checkout terminals or payment hardware.",
    primaryStat: "3 Providers",
    primaryStatLabel: "Toast, Square & Clover API connectors",
    secondaryStat: "100%",
    secondaryStatLabel: "Idempotent, duplicate-proof order sync",
    accentColor: "emerald",
    ...
    features: [
      {
        title: "Universal POS Connectors",
        description:
          "Pre-built integrations for Toast (API v2), Square (Connect v2), and Clover (REST v3). Authorize securely using read-only API credentials.",
        badge: "Multi-Provider",
        iconName: "Store",
      },
      {
        title: "Multi-Location Outlet Mapping",
        description:
          "Map individual POS locations and registers directly to Restobird restaurant outlets for clean, multi-unit franchise reporting.",
        badge: "Location Mapping",
        iconName: "LayoutGrid",
      },
      {
        title: "Idempotent Order & Modifier Sync",
        description:
          "Preserves original provider order numbers, line items, item modifiers, taxes, tips, and discounts. Order updates and refunds sync without duplicates.",
        badge: "Duplicate-Proof",
        iconName: "ShieldCheck",
      },
      {
        title: "Unified Live Orders Feed",
        description:
          "Monitor order volume, gross sales, net revenue, and average order value across all connected POS terminals in one responsive dashboard.",
        badge: "Consolidated Stream",
        iconName: "Flame",
      },
      {
        title: "Automated Inventory Depletion",
        description:
          "Imported POS tickets automatically trigger gram-level stock depletion for linked recipes and ingredients without duplicate entry.",
        badge: "BOM Linked",
        iconName: "MonitorSmartphone",
      },
      {
        title: "Read-Only Security & Data Retention",
        description:
          "Zero write-access to your cash drawer or card processing. If an integration is disconnected, historical orders remain intact for accounting audits.",
        badge: "Enterprise Security",
        iconName: "CreditCard",
      },
    ],
    beforeRestoBird: [
      "Logging into 3 different POS dashboards to reconcile daily sales across multiple locations.",
      "Manual spreadsheet re-entry of ticket sales to calculate food cost and ingredient usage.",
      "Fragmented view of tips, sales tax liabilities, and customer order volumes.",
      "High cost and complexity of switching POS systems just to get modern reporting.",
    ],
    withRestoBird: [
      "Connect your existing POS in minutes and view all orders in one unified live feed.",
      "Automated ingredient depletion triggered directly from Toast, Square, and Clover tickets.",
      "Consolidated sales metrics, AOV, gross volume, and net revenue across all outlets.",
      "Keep your existing POS hardware, merchant processing agreements, and staff terminals.",
    ],
    techSpecs: [
      { label: "Supported Providers", value: "Toast (API v2 Bulk), Square (Connect v2), Clover (REST v3)" },
      { label: "Connection Protocol", value: "Encrypted OAuth 2.0 & Partner REST APIs" },
      { label: "Synchronization", value: "Automated background sync & on-demand manual refresh" },
      { label: "Data Ingestion", value: "Orders, line items, modifiers, taxes, tips, refunds, discounts" },
      { label: "Security & Permissions", value: "Read-only order scopes, AES-256 encrypted credential storage" },
      { label: "Order Retention", value: "Persistent read-only storage across disconnections" },
    ],
    faqs: [
      {
        question: "Does Restobird replace our existing POS, card terminals, or payment processor?",
        answer:
          "No. Restobird is not a standalone POS, billing terminal, or payment processor. We connect to your existing POS systems (such as Toast, Square, and Clover), import your order data, and display it in a unified dashboard. You keep your current hardware and payment contracts.",
      },
      {
        question: "What happens to our historical order data if we disconnect a POS integration?",
        answer:
          "All previously imported orders and sales reports remain safely stored in Restobird as read-only historical records for accounting and tax audits. Restobird simply ceases syncing new orders from that provider.",
      },
      {
        question: "How does Restobird prevent duplicate orders during retries and repeated imports?",
        answer:
          "All imports are strictly idempotent. Restobird tracks unique provider order identifiers (such as Toast GUIDs and Square Order IDs). When an order is re-fetched, updates, refunds, or cancellations are applied to the existing record rather than creating duplicate sales.",
      },
    ],
    quote: {
      text: "Restobird connected to our Toast terminals across 3 locations in minutes. Having a single orders feed with automatic inventory deduction without changing our POS hardware was a game changer.",
