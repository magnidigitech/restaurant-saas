        ...
        <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
          ...
          >
            <div className="space-y-1">
              ...
              <p className={`text-xs ${isDark ? "text-[#8F95A3]" : "text-slate-500"}`}>
                Manage commercial distributors, payment terms, contact leads, and item price contracts.
              </p>
            </div>
          ...
          {vendors.length === 0 ? (
            ...
            >
              ...
              <h3 className="text-sm font-semibold">No suppliers registered</h3>
              <p className={`text-xs max-w-sm mx-auto ${isDark ? "text-[#8F95A3]" : "text-slate-500"}`}>
                Click "+ Add Vendor" to configure your procurement supply lines and catalog contracts.
              </p>
            </div>
          ) : (
            <>
