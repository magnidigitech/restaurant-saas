  ...
  return (
    ...
    >
      ...
      <main className="flex-1 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        >
          {/* Ambient Glow Orbs */}
          <div className="absolute -right-16 -top-16 w-72 h-72 bg-cyan-500/10 dark:bg-cyan-500/20 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="relative z-10 space-y-2 sm:space-y-2.5 w-full md:w-auto min-w-0">
            <div className="flex items-center justify-between sm:justify-start gap-2 flex-wrap">
              ...
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border border-cyan-500/20 whitespace-nowrap">
            ...
            <div className="flex items-center gap-2.5 sm:gap-3">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-cyan-500 via-teal-600 to-blue-600 text-white flex items-center justify-center shadow-md shadow-cyan-500/20 shrink-0 border border-white/20">
          ...
          <div className="relative z-10 flex flex-wrap items-center gap-2.5 shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`px-3.5 py-1.5 sm:py-2 rounded-xl text-xs font-medium border transition cursor-pointer flex items-center gap-1.5 whitespace-nowrap ${
                  isDark
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-end md:items-center justify-center z-50 p-0 md:p-4 animate-in fade-in duration-150">
          ...
          >
            ...
            <div className="flex justify-between items-center">
              ...
              <button onClick={() => setShowAdjust(false)} className="text-slate-400 hover:text-slate-600 dark:hover:text-white text-base cursor-pointer p-1">
                ✕
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-end md:items-center justify-center z-50 p-0 md:p-4 animate-in fade-in duration-150">
          ...
          >
            ...
            <div className="flex justify-between items-center">
              ...
              <button onClick={() => setShowWastage(false)} className="text-slate-400 hover:text-slate-600 dark:hover:text-white text-base cursor-pointer p-1">
                ✕
              </button>
            </div>
