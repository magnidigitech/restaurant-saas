        ...
        >
          ...
          <div className="relative z-10 space-y-2.5 sm:space-y-3 w-full md:w-auto min-w-0">
            ...
            <div className="flex items-center justify-between sm:justify-start gap-2 flex-wrap">
              ...
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-blue-500/10 text-[#0071E3] dark:text-blue-400 border border-blue-500/20 whitespace-nowrap">
                ...
                <span className="hidden sm:inline">Administration & Security</span>
                <span className="sm:hidden">Access Security</span>
              </span>
            </div>
            ...
            <div className="flex items-center gap-2.5 sm:gap-3.5">
              ...
              <div className="min-w-0">
                ...
                <span className={`text-[10px] sm:text-xs block sm:hidden font-medium mt-0.5 ${isDark ? "text-[#8F95A3]" : "text-slate-500"}`}>
                  {grants.length} active grants • {memberships.length} users enrolled
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 flex flex-wrap items-center gap-3 shrink-0">
              ...
              <div className="text-left">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs font-bold text-slate-900 dark:text-white">
                    Authorization Engine Active
                  </span>
                </div>
                <span className={`text-[10px] font-medium block mt-0.5 ${isDark ? "text-[#8F95A3]" : "text-slate-500"}`}>
                  {grants.length} Grants Scoped • {memberships.length} Users Enrolled
                </span>
              </div>
            </div>
            ...
            <button
              ...
              className="px-4 py-2 bg-[#0071E3] hover:bg-[#0077ED] active:scale-[0.98] text-white text-xs font-semibold rounded-xl transition shadow-sm cursor-pointer whitespace-nowrap"
            >
              + New Access Grant
            </button>
          </div>
