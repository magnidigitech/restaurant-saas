        ...
        <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
            ...
            >
              ...
              {isExpandedView && (
                <div className="min-w-0 animate-in fade-in duration-200">
                  ...
                  <span className="text-[10px] text-slate-500 dark:text-slate-400 font-medium truncate block">Restaurant Operations</span>
                </div>
              )}
            </div>
          ...
          {isExpandedView && (
            <div className="px-5 py-2 bg-slate-50 dark:bg-white/[0.02] border-b border-black/[0.04] dark:border-white/[0.04] flex items-center justify-between text-xs text-slate-600 dark:text-slate-400 shrink-0 animate-in fade-in duration-150 font-medium">
              ...
              <span className="text-[10px] text-slate-500 dark:text-slate-400">Live Suite</span>
            </div>
          )}
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-semibold transition-all cursor-pointer ${
                      isActive
                        ...
                        : isExpanded
                        ? "font-bold text-slate-950 dark:text-white bg-slate-100 dark:bg-white/[0.06]"
                          ...
                          <button
                            ...
                            className={`w-full flex items-center justify-between px-2.5 py-1.5 rounded-lg text-[11px] font-medium transition cursor-pointer group ${
                              isChildActive
                                ...
                                : "text-slate-600 dark:text-slate-400 hover:text-slate-950 dark:hover:text-white hover:bg-slate-100/80 dark:hover:bg-white/[0.05]"
                            }`}
                          >
        ...
        <div className="p-2.5 border-t border-black/[0.05] dark:border-white/[0.06] space-y-2 shrink-0">
          {!isExpandedView ? (
            ...
            <div className="space-y-2 animate-in fade-in duration-150">
              <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-slate-100 dark:bg-white/[0.04] border border-slate-200/60 dark:border-white/[0.06]">
              ...
              >
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-[10px] text-slate-500 dark:text-slate-400 font-medium truncate">Tenant: {subdomain}</div>
                  </div>
                </div>
                ...
                <button
                  ...
                  title="Sign Out"
                  className="p-1.5 rounded-lg text-slate-500 hover:text-rose-600 dark:text-slate-400 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition cursor-pointer shrink-0"
                >
